...
public class ExchangeRatesClient implements ExchangeRateClient {
    ...
    private static final String NULL_RESPONSE_LOG = "Received null response from ExchangeRatesAPI";
    private static final String UNSUCCESSFUL_RESPONSE_LOG = "ExchangeRatesAPI returned unsuccessful response";
    private static final String EMPTY_RATES_LOG = "ExchangeRatesAPI returned empty rates";
    ...
    @Autowired
    public ExchangeRatesClient(@Qualifier("exchangeratesRestClient") final RestClient restClient,
    ...
    private CurrencyExchangeResponse executeRequest(final Optional<String> symbols) {
        ...
        try {
            ...
            final ExchangeRatesApiResponse response = restClient.get()
                    .uri(url)
                    .retrieve()
