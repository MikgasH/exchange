...
public class MockService2Client implements ExchangeRateClient {
    ...
    private final RestClient mockService2RestClient;
    ...
    public CurrencyExchangeResponse getLatestRates() {
        ...
        final FixerioResponse response = mockService2RestClient.get()
                .uri(ENDPOINT)
                .retrieve()
    ...
    public String getProviderName() {
        return ApiProvider.MOCK_SERVICE_2.getDisplayName();
    }
}
