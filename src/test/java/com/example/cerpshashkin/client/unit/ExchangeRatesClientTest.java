...
class ExchangeRatesClientTest {
    ...
    void getLatestRates_ShouldCallBaseClientWithCorrectParameters() {
        ReflectionTestUtils.setField(exchangeRatesClient, "exchangeratesUrl", "http://test.url");
        ReflectionTestUtils.setField(exchangeRatesClient, "exchangeratesAccessKey", "test-key");
        ...
        when(baseClient.executeApiCall(
                anyString(),
                eq(ExchangeRatesApiResponse.class),
                any(),
                eq("ExchangeRatesAPI"),
